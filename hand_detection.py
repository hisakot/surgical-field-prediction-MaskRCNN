...
class Dataset(object):
    ...
    def __getitem__(self, idx):
        ...
        for idx, region in enumerate(regions):
            ...
            # label
            labels[idx] = list(region['region_attributes']['hand'].keys())[0]
...
if __name__ == '__main__':
    ...
    # open via json file
    tmp = open('../hand-data/via_annotation_hand.json', 'r')
    ...
    if not args.evaluation:
        ...
        def get_coloured_mask(mask, pred_cls):
            ...
            colours = [[0, 0, 0],[0, 255, 0],[0, 255, 255],[255, 255, 0],[80, 70, 180],[180, 40, 250],[245, 145, 50],[70, 150, 250],[50, 190, 190],[255, 0, 255]]
#             r[mask == 1], g[mask == 1], b[mask == 1] = colours[CLASS_NAMES.index(pred_cls)]
            r[mask == 1], g[mask == 1], b[mask == 1] = colours[9]
